...
type Config struct {
	...
	DisablePassthroughV1PrefixNormalization bool                                   // Disable /p/{provider}/v1/... normalization while keeping canonical /p/{provider}/... routes
...
func New(provider core.RoutableProvider, cfg *Config) *Server {
	...
	if cfg != nil && cfg.DisablePassthroughV1PrefixNormalization {
