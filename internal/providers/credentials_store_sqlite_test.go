...
func newSQLiteCredentialTestStore(t *testing.T) *SQLiteCredentialStore {
	t.Helper()
...
func TestSQLiteCredentialStoreRoundTrip(t *testing.T) {
	t.Parallel()
	store := newSQLiteCredentialTestStore(t)
...
func TestSQLiteCredentialStoreGetMissing(t *testing.T) {
	t.Parallel()
	store := newSQLiteCredentialTestStore(t)
	ctx := context.Background()
...
func TestSQLiteCredentialStoreListOrdersByName(t *testing.T) {
	t.Parallel()
	store := newSQLiteCredentialTestStore(t)
	ctx := context.Background()
