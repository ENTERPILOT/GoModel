...
func TestProviderReplayChatUsageContract(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			require.Positive(t, resp.Usage.PromptTokens, "prompt tokens should be normalized")
			require.Positive(t, resp.Usage.CompletionTokens, "completion tokens should be normalized")
