...
- [ ] Managed outbound proxy pools: health checks, failover between proxies, and assignment rules across providers (per-provider `proxy_url` is in [core](/providers/outbound-proxy))
