---
title: "llama.cpp Server: Connect It to an LLM Gateway"
...
icon: "server"
keywords: ["llama.cpp", "llama-server", "llama.cpp router mode", "LM Studio", "local models", "self-hosted", "OpenAI-compatible server"]
---
