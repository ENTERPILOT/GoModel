...
- Speech `response_format` values other than `wav`/`pcm`, and transcription
  `srt`/`vtt` formats (MiMo synthesizes wav/pcm16 and returns plain text).
