...
# GOMODEL_ANTHROPIC_DEFAULT_MAX_TOKENS=4096                 # injected when callers omit max_tokens
```
...
<Note>
  ...
  injects `GOMODEL_ANTHROPIC_DEFAULT_MAX_TOKENS` (default `4096`) when a caller omits
