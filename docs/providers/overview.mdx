...
- **OpenCode Go** — OpenCode Zen exposes both OpenAI-style `/chat/completions`
  and Anthropic-style `/messages`; GoModel routes the OpenAI-compatible surface,
  which serves the chat models (GLM, Kimi, DeepSeek, MiMo).
