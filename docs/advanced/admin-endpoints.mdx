...
Extension identities such as SSO sessions are global admins by default; their
user path is a login identity, not a tenancy. An extension can confine a
session by setting an access scope explicitly.
