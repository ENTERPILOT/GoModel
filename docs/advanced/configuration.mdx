...
<Note>
  ...
  compression) and every prompt guardrail that edited it store the full
  rewritten body alongside the original client body in the audit entry. Disabling it keeps the revision metadata (rewriter
