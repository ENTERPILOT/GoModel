...
description: "Manage OpenAI-compatible conversations and their items through GoModel."
...
again. Applications where duplicate calls have material cost or side effects
should inspect the conversation history before retrying.
