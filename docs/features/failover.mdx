---
title: "Failover"
description: "Configure GoModel failover with manual rules and know when fallback attempts run."
icon: "shuffle"
...
The Dashboard can generate suggested rules from model metadata, but suggestions
must be saved as manual rules before they affect traffic.
