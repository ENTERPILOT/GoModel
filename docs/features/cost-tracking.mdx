...
<Frame caption="The Pricing override editor on the Models page">
  <img
    src="/features/pricing-override-models.png"
    alt="GoModel Models page with the Pricing override dialog open over the registered model list"
  />
</Frame>
