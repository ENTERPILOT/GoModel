...
3. The **model catalog** (the `ai-model-list` registry).
...
{/* TODO: replace this placeholder with a screenshot of the Models page showing a model's "Pricing override" action.
     Suggested: <img src="/features/pricing-override-models.png" alt="GoModel Models page with the Pricing override action on a model row" style={{ width: "100%", maxWidth: "1280px", height: "auto" }} className="rounded-lg" /> */}
<div style={{ border: "2px dashed #d0d0d0", borderRadius: "8px", padding: "56px 16px", textAlign: "center", color: "#999", fontStyle: "italic" }}>
  Screenshot: Models page — opening a model's Pricing override
</div>

{/* TODO: replace this placeholder with a screenshot of the "Pricing override" editor (Selector, Price Type rows, USD Value).
     Suggested: <img src="/features/pricing-override-editor.png" alt="GoModel Pricing override editor with input and output USD rates" style={{ width: "100%", maxWidth: "1280px", height: "auto" }} className="rounded-lg" /> */}
<div style={{ border: "2px dashed #d0d0d0", borderRadius: "8px", padding: "56px 16px", textAlign: "center", color: "#999", fontStyle: "italic", marginTop: "16px" }}>
  Screenshot: Pricing override editor (price type + USD value)
</div>
