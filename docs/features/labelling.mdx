...
GOMODEL_TAGGING_HEADER_1_PREFIX=tag-    # optional, trimmed from each extracted label only
GOMODEL_TAGGING_HEADER_1_DONOTPASS=true # optional, default false (headers are forwarded as-is)
