...
- Have credentials for at least one upstream model provider ready.
...
credentials. This guide's examples use OpenAI, but you can choose another
provider and one of its models.
