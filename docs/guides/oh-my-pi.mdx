---
title: "oh-my-pi (omp): Change Effort & Custom Providers"
sidebarTitle: "oh-my-pi"
...
keywords: ["oh-my-pi", "omp", "omp change effort", "omp custom provider", "models.yml", "coding agent", "reasoning effort", "setup guide"]
---
