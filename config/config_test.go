...
func TestBuildDefaultConfig(t *testing.T) {
	...
	if got, want := cfg.Server.EnabledPassthroughProviders, []string{"openai", "anthropic", "chutes", "openrouter", "kilo", "zai", "sglang", "vllm", "llmd", "deepseek"}; !reflect.DeepEqual(got, want) {
...
func TestLoad_ConfigExample_UsesNestedModelCacheSettings(t *testing.T) {
	...
	withTempDir(t, func(dir string) {
		...
		wantProviders := []string{"openai", "anthropic", "chutes", "cohere", "openrouter", "kilo", "zai", "sglang", "vllm", "llmd", "deepseek", "bailian"}
