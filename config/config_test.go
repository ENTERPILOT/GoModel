...
func TestBuildDefaultConfig(t *testing.T) {
	...
	if got, want := cfg.Server.EnabledPassthroughProviders, []string{"openai", "anthropic", "openrouter", "kilo", "zai", "sglang", "vllm", "llamacpp", "llmd", "deepseek", "hetzner", "edenai"}; !reflect.DeepEqual(got, want) {
