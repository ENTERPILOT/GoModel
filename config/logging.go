...
type LogConfig struct {
	...
	// alongside the original in the audit entry, and the last prompt
	// guardrail that edited the prompt stores the body as forwarded after
	// the whole guardrail chain. Requires LogBodies.
